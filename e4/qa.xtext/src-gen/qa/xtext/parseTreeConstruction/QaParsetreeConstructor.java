...
public class QaParsetreeConstructor extends org.eclipse.xtext.parsetree.reconstr.impl.AbstractParseTreeConstructor {
 ...
 *
 * Question:
 * 	("ID" name=ID)? text=EString "?"? correct=Answer "!"? ("Candidates" ":" candidates+=Answer (","
 * 	candidates+=Answer)*)? nextRules+=NextRule*;
 *
 **/
